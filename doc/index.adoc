...
.Server components according to https://dataflow.spring.io/docs/concepts/architecture/
image::https://dataflow.spring.io/static/19e89c2894aa4586aec3336ac4e6954b/5105f/arch-overview.webp[align=center]
